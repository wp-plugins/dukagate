...
editstyle = '<?php echo DG_DUKAGATE_URL; ?>/js/wyzz0.65/wyzzstyles/editarea.css';

// Do we want to try to clean the code to emulate xhtml? 1=Yes, 0=No
xhtml_out = 0;

// Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="<?php echo DG_DUKAGATE_URL; ?>/js/wyzz0.65/wyzzstyles/style.css">\n');
